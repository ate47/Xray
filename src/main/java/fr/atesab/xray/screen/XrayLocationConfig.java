...
public class XrayLocationConfig extends XrayScreen {
    ...
    public void render(DrawContext drawContext, int mouseX, int mouseY, float delta) {
        ...
        drawContext.drawCenteredTextWithShadow(textRenderer, Text.translatable("x13.mod.location"), width / 2,
                height / 2 - 52 - textRenderer.fontHeight, 0xffffffff);
        GuiUtils.drawRightString(drawContext, textRenderer, I18n.translate("x13.mod.location.format") + ": ", format,
                0xffffffff);
        format.render(drawContext, mouseX, mouseY, delta);
